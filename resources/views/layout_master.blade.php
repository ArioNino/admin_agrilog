    ...
    <div class="flex h-screen bg-gray-50 " :class="{ 'overflow-hidden': isSideMenuOpen }">
        ...
        <aside class="z-20 hidden w-64 overflow-y-auto bg-white  md:block flex-shrink-0">
            <div class="py-4 text-gray-500 ">
                <a class="ml-10 text-lg font-bold text-gray-800" href="#">
                    Agrilog
                </a>
                <ul class="mt-6">
                ...
                <ul>
                    ...
                    <li class="relative px-6 py-3">
                        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800"
                            ...
                            <span class="ml-4">Commodities </span>
                        </a>
                    </li>
                    <li class="relative px-6 py-3">
                        <button
                        ...
                        <template x-if="isPagesMenuOpen">
                          <ul
                            ...
                            >
                              <a class="w-full" href="pages/login.html">Petani</a>
                            </li>
                            <li
                              class="px-2 py-1 transition-colors duration-150 hover:text-gray-800"
                            >
                              <a class="w-full" href="pages/login.html">Pengepul</a>
                            </li>
                          </ul>
                        </template>
                      </li>
                    ...
                    <div class="flex justify-center flex-1 lg:mr-32">
                        <div class="relative w-full max-w-xl mr-6 focus-within:text-green-500">
                            <div class="absolute inset-y-0 flex items-center pl-2">
                                <svg class="w-4 h-4" aria-hidden="true" fill="green" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                            ...
                            <input
                                class="w-full pl-8 pr-2 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md focus:placeholder-gray-500 focus:bg-white focus:border-green-300 focus:outline-none focus:shadow-outline-green form-input"
                        ...
                        <li class="relative">
                            <button
                                ...
                                <span aria-hidden="true"
                                    class="absolute top-0 right-0 inline-block w-3 h-3 transform translate-x-1 -translate-y-1 bg-red-600  border-white rounded-full dark:border-gray-800"></span>
                            </button>
